<template>
  <v-container>
    <v-card outlined>
      ...
      <v-card-text>
        <v-textarea v-model="Content" solo flat auto-grow readonly rows="12"></v-textarea>
      </v-card-text>
      ...
      <v-card-actions>
        ...
        <v-card-text>
          <v-text-field v-model="Comment" density="compact" label="comment" hide-details single-line></v-text-field>
        </v-card-text>
...
export default {
  ...
  async created() {
    ...
    this.Author = this.approverList[result["document"]["AuthorID"] - 1].title;
